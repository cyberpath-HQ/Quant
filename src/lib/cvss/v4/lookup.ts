...
/**
 * @fileoverview CVSS v4.0 Lookup Tables
 * @description Contains the MacroVector lookup table and metric level definitions
 *
 * These lookup tables are generated from the official CVSS v4.0 specification.
 * The MacroVector table maps 270 equivalence class combinations to scores.
 *
...
/**
 * MacroVector to Score lookup table
 * Contains all 270 valid MacroVector combinations and their base scores
 */
export const CVSS_V4_LOOKUP: Readonly<Record<string, number>> = {
    "000000": 10,
    "000001": 9.9,
    "000010": 9.8,
    "000011": 9.5,
