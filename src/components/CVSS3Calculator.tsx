...
import { cvss3Metrics, getSeverityRating } from "@/lib/cvss/metrics-data";
...
export function CVSS3Calculator({ version, initialMetrics }: CVSS3CalculatorProps) {
  ...
  const [metrics, setMetrics] = useState<CVSSv3Metrics>(() => {
