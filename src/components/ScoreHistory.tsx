...
function ChartDialog({ open, onOpenChange, selectedEntries }: ChartDialogProps): React.ReactElement {
  ...
  const [xAxisLabel, setXAxisLabel] = useState(`Severity`);
        ...
        <div className="space-y-6">
          <div ref={chartRef} className="relative">
              ...
              <ResponsiveContainer width="100%" height="100%">
                {chartType === `bar` ? (
                  <BarChart data={barData}>
                    ...
                    <Bar dataKey="count" fill="#8884d8" radius={[barRadius, barRadius, 0, 0]}>
            ...
            <img
              ...
              className="absolute bottom-2 right-4 h-4 pointer-events-none"
            />
          </div>
          <div className="space-y-4">
            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
              ...
              <Field>
                <FieldContent>
                  ...
                  <Select value={exportFormat} onValueChange={(value: `png` | `webp`) => setExportFormat(value)}>
                    <SelectTrigger>
                      <SelectValue />
                    </SelectTrigger>
                    <SelectContent>
              ...
              <Field>
                <FieldContent>
                  ...
                  <Slider
                    ...
                    step={5}
                  />
                  <FieldDescription>{transparency}%</FieldDescription>
                </FieldContent>
              </Field>
              {chartType === `bar` && (
                <>
                  ...
                  <Field>
                    <FieldContent>
                      ...
                      <Slider
                        ...
                        step={1}
                      />
                      <FieldDescription>{barRadius}px</FieldDescription>
                    </FieldContent>
                  </Field>
                </>
              )}
